...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_team_providers_type"), table_name="team_providers", if_exists=True)
    op.drop_index(op.f("ix_team_providers_team_id"), table_name="team_providers", if_exists=True)
    op.drop_index("idx_team_provider_name", table_name="team_providers", if_exists=True)
