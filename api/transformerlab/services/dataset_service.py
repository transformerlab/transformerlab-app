...
async def load_local_dataset(dataset_dir, data_files=None, streaming=False):
    ...
    if data_files is None:
        try:
            ...
            entries = await storage.ls(dataset_dir, detail=False)
        except Exception:
            entries = []
