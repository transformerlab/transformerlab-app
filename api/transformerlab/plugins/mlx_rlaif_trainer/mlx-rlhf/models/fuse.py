# File copied from mlx-examples at https://github.com/ml-explore/mlx-examples/blob/main/lora/fuse.py
#
# Copyright © 2023 Apple Inc.

"""
Example command for saving an SFT model:
python fuse.py --model TinyLlama/TinyLlama-1.1B-Chat-v1.0 --adapter-file lora_weights.npz --save-path ./sft_fine_tune/

Example save of a reward model:
python fuse.py --model TinyLlama/TinyLlama-1.1B-Chat-v1.0 --adapter-file lora_weights.npz --save-path ./reward_model/
