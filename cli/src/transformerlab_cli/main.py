...
from transformerlab_cli.commands.workspace import app as workspace_app
...
app.add_typer(workspace_app, name="workspace", help="Workspace storage diagnostics", no_args_is_help=True)
