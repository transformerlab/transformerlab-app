...
_A robustness study of open autoregressive codec-TTS: a tiny test-time check removes catastrophic failures across four models and three codecs. And we can distill it back into the model for free where it actually matters._
