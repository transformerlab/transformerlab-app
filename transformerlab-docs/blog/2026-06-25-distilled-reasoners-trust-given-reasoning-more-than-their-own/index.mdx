...
title: 'Distilled reasoning models trust the reasoning you give them more than the reasoning they write'
...
_Reasoning models write out their thinking before they answer. We tested whether the answer actually depends on that thinking, on two distilled reasoning models. When we hand the model a chain of steps to follow, its answer tracks those steps almost perfectly. When the model writes its own steps, only about half of them actually change the answer, and the ones that matter sit near the end._
