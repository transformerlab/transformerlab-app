...
The full method, the controls, and every number are in the paper. The intervention code and the synthetic-chain benchmark are available from the authors on request.
