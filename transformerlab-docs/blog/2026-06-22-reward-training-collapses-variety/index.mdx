...
The full paper, with the per-objective and per-seed results, the Pareto curves, and the limitations in detail, is here: [Reward Maximization Collapses Generative Diversity](/papers/reward-maximization-collapses-diversity).
