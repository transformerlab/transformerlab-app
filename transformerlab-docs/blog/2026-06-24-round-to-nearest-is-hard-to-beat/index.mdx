...
Built on Cohere Labs' North-Mini-Code-1.0 (Apache-2.0). The streaming-GPTQ code and evaluation harness are open. Read the [full paper](/papers/round-to-nearest-hard-to-beat).
