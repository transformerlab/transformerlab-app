...
That made it the perfect hypothesis to test. CNNs are a bit boring, and getting a Transformer model to work on a budget would be amazing. LET'S FIND OUT!
...
I started writing a blog post about how "transformers don't work on small driving data" (and why what Tesla does is out of reach for amature developers) and started to move on. The breakthrough was realizing the problem was not the architecture, it was **how I was adapting it**. So I used the exact same ViT backbone (that failed bady), and tried three different ways of training it:
