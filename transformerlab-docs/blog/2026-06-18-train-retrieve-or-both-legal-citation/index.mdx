...
| Evidenced train-vs-retrieve answer        | yes    | &mdash;   | met     |

And the full grid, with ablations:

| Arm                | Config                     | k       | recall@k  | Exact     | F1        |
| ------------------ | -------------------------- | ------- | --------- | --------- | --------- |
| base zero-shot     | &mdash;                    | &mdash; | &mdash;   | 0.00      | 0.00      |
| SFT-only           | LoRA r32/400               | &mdash; | &mdash;   | 0.148     | 0.167     |
...
| RAG-only           | bge-large + reranker, k=10 | 10      | 0.852     | 0.37      | &mdash;   |
| hybrid             | bge-large + reranker, k=10 | 10      | 0.852     | 0.37      | &mdash;   |
