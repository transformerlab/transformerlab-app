...
_Paper and the full reproducibility package (prompts, the instrumental filter, seeds, and the exact recipe) are coming soon. Built on three open models we did not train: Stable Audio 3 Medium, ACE-Step 1.5, and DiffRhythm 2; evaluated on the Song Describer Dataset._
